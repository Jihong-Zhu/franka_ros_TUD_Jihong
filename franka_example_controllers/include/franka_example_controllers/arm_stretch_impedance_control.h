...
class ArmStretchImpedanceController : public controller_interface::MultiInterfaceController<
 ...
 private:
  ...
  Eigen::Matrix3d rotation_matrix_translational_stiffness_;
  ...
  // Re-orientation of translational stiffness
  ros::Subscriber sub_rotation_mat_;
  void stiffnessReorientation(const std_msgs::Float32MultiArray::ConstPtr& rotation_matrix_flattened);
